...
public interface ClientUserService extends IService<ClientUser> {
     ...
     * @date 2022/8/25 15:16
     **/
    void doRegister(String account, String password, String type, String idCardType, String idCardNumber, String realName, String workUnit);
     ...
     */
    List<ClientUser> getVolunteerListByParentId(String parentId);
     ...
     */
    Page<ClientUser> volunteerAuditPage(ClientUserPageParam clientUserPageParam);
     ...
     * @date 2025/10/20 06:42
     */
    ClientUser volunteerDetail(ClientUserIdParam clientUserIdParam);
     ...
     * @date 2025/10/20 06:42
     */
    void approveVolunteer(ClientUserIdParam clientUserIdParam);
     ...
     * @date 2025/10/20 06:42
     */
    void rejectVolunteer(ClientUserRejectParam rejectParam);
     ...
     * @date 2025/10/20 06:42
     */
    void batchApproveVolunteer(ClientUserBatchAuditParam batchParam);
     ...
     * @date 2025/10/20 06:42
     */
    void batchRejectVolunteer(ClientUserBatchAuditParam batchParam);
}
