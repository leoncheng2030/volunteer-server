...
public class ClientUserApiProvider implements ClientUserApi {
    ...
    @Resource
    private vip.xiaonuo.client.modular.user.service.ClientUserExtService clientUserExtService;
    ...
    public void updateUserPoints(String userId, int points) {
        vip.xiaonuo.client.modular.user.entity.ClientUserExt userExt = clientUserService.getOrCreateClientUserExt(userId);
        userExt.setVolunteerIntegral(points);
        clientUserExtService.updateById(userExt);
    }
