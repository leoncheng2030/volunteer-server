...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthPicValidCodeResult getPicCaptcha(String type) {
        ...
        // 生成验证码，随机4位字符
        LineCaptcha circleCaptcha = CaptchaUtil.createLineCaptcha(100, 38,4,0);
    ...
    public void register(AuthRegisterParam authRegisterParam, String type) {
        ...
        // 获取账号
        String account = authRegisterParam.getPhone();
        // 获取密码
        ...
        if(SaClientTypeEnum.B.getValue().equals(type)) {
            ...
            clientLoginUserApi.doRegister(account, passwordDecrypt, authRegisterParam.getType(), authRegisterParam.getIdCardType(), authRegisterParam.getIdCardNumber(), authRegisterParam.getRealName(), authRegisterParam.getWorkUnit());
        }
    }
    ...
    public void updateUserInfo(ClientUserUpdateInfoParam clientUserUpdateInfoParam) {
        // 通过ClientUserApi调用更新用户资料的方法
        clientUserApi.updateUserInfo(clientUserUpdateInfoParam);
    }
}
